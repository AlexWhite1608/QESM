...
public class Globals {
    ...
    public static final int CLIENT_TASK_SIZE_MEAN_MAX = 30; // Massimo del valor medio dei task generati

    public static final boolean ALLOW_CLIENT_ARRIVAL_DEPARTURE = true; // Abilita l'arrivo e l'uscita dei client
    public static final double ARRIVAL_PROBABILITY = 0.7; // Probabilità di arrivo di un client
    public static final double DEPARTURE_PROBABILITY = 0.7; // Probabilità di uscita di un client
}
